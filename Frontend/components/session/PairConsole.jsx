    ...
    <div className="w-full max-w-md rounded-2xl border border-edge bg-surface p-6 sm:p-8">
      ...
      {!loading && mode === "pair" && (
        <div className="mb-4 flex min-h-[60px] flex-col items-center justify-center gap-2 rounded-xl border border-edge bg-surface2 px-4 py-4 text-center">
          ...
          {result.state === "ok" && (
            <span className="break-all font-mono text-xl font-semibold tracking-[0.16em] text-azure-500 sm:tracking-[0.22em]">
              {result.text}
            </span>
          )}
          {result.state === "error" && (
            <span className="flex items-center justify-center gap-1.5 text-xs text-red-400 [overflow-wrap:anywhere]">
          ...
          {qr ? (
            <>
              ...
              <img
                ...
                className="mx-auto mb-3 aspect-square w-full max-w-[210px] rounded-lg"
              />
