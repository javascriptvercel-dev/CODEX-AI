...
export default function GenerateConsole() {
  ...
  const canGenerate =
    name.trim().length > 0 && number.trim().length > 0;
...
function ToggleRow({ label, hint, checked, onChange }) {
  return (
    <button
      ...
      className="group flex w-full select-none items-center justify-between gap-4 rounded-lg border border-edge bg-surface2 px-3.5 py-3 text-left transition hover:border-azure-500/40 active:scale-[0.995]"
    >
      <div className="min-w-0">
