...
export default function SubmissionCard({ submission, onApprove, onReject, onSaved }) {
  ...
  return (
    <div className="group rounded-2xl border border-edge bg-surface p-5 transition hover:border-azure-500/30 hover:shadow-lg hover:shadow-black/5">
      ...
      {submission.status === "pending" ? (
        ...
        >
          {submission.status === "approved" ? <Check size={11} /> : <X size={11} />}
          {submission.status}
        </span>
      )}
    </div>
